...
export const greetings = [
  () => {
    ...
    return `Welcome to the Celestial Oracle. ${dynamicText}! Let me ask you something: have you ever met an Angel before?`;
  },
  ...
  () => {
    ...
    return `Hello my dear, I am so happy you are here! Please take a moment to meet a celestial Angel: It will make your ${weekday} much better.`
  },
];
